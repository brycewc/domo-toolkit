...
When proposing scope for a new action button, view, or service, ask: "Can a user already do this easily in Domo's UI?" If yes, push back or omit it. When an API endpoint supports more fields than the feature exposes, that is often intentional — confirm before broadening scope.
