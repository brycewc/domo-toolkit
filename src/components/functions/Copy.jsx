...
export function Copy({
  ...
  // Enable long press for types with additional copy options OR pages with filters
  const hasExtraCopyOptions = ['DATA_SOURCE', 'DATA_APP_VIEW', 'WORKSHEET_VIEW', 'PAGE'].includes(
