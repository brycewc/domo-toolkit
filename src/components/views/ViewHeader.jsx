 ...
 * view (ObjectDetails) omits `feature`. A large `featureIcon` leads the title
 * row, and the `beta` chip (when present) leads the subtext row.
 *
 * @param {Object} props
 * @param {React.ReactNode} [props.featureIcon] - Large icon identifying the view, rendered at the start of the title row.
 ...
 * @param {boolean} [props.beta] - Renders the standard "Beta" chip at the start of the subtext row.
